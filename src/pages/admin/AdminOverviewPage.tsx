...
export const AdminOverviewPage: React.FC = () => {
  ...
  const getStatusBadge = (status: string) => {
    ...
    if (s === 'placed' || s === 'pending') {
      return (
        <span className="inline-flex items-center gap-1.5 px-2.5 py-1 text-[11px] font-semibold rounded-full bg-amber-50 text-amber-700 border border-amber-200">
  ...
  return (
    <div className="space-y-8 animate-fade-in text-slate-800 pb-12 select-none">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-6">
        <div>
          <div className="flex items-center gap-2 text-xs font-mono text-amber-600 mb-1 font-semibold">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            onClick={loadData}
            disabled={loading}
            className="flex items-center gap-2 px-3.5 py-2 bg-white hover:bg-slate-50 border border-slate-200 text-xs font-semibold text-slate-700 transition-colors rounded-lg shadow-2xs cursor-pointer"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold transition-all shadow-sm rounded-lg cursor-pointer"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="p-5 bg-white border border-slate-200 rounded-xl shadow-xs hover:shadow-md transition-all group">
            ...
            <p className="text-2xl sm:text-3xl font-extrabold font-mono text-slate-900 mt-3">
              ...
              <span className="text-sm font-sans text-amber-600 font-bold">ج.م</span>
            </p>
          ...
          <div className="p-5 bg-white border border-slate-200 rounded-xl shadow-xs hover:shadow-md transition-all group">
            <div className="flex items-center justify-between text-slate-500">
              ...
              <div className="w-9 h-9 rounded-lg bg-amber-50 text-amber-600 flex items-center justify-center border border-amber-100 shadow-2xs">
            ...
            <Link
              to="/admin/orders"
              className="inline-flex items-center gap-1 text-[11px] text-amber-600 hover:text-amber-700 hover:underline mt-2 font-bold"
            >
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <Link
            to="/admin/products"
            className="p-4 bg-white border border-slate-200 hover:border-amber-400 hover:shadow-md transition-all flex flex-col justify-between group rounded-xl"
          >
          ...
          <Link
            to="/admin/orders"
            className="p-4 bg-white border border-slate-200 hover:border-sky-400 hover:shadow-md transition-all flex flex-col justify-between group rounded-xl"
          >
          ...
          <Link
            to="/admin/marketing"
            className="p-4 bg-white border border-slate-200 hover:border-emerald-400 hover:shadow-md transition-all flex flex-col justify-between group rounded-xl"
          >
          ...
          <Link
            to="/admin/shipping"
            className="p-4 bg-white border border-slate-200 hover:border-purple-400 hover:shadow-md transition-all flex flex-col justify-between group rounded-xl"
          >
      ...
      <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-xs">
        <div className="p-4 sm:p-5 border-b border-slate-200 flex items-center justify-between bg-slate-50/50">
          ...
          <Link
            to="/admin/orders"
            className="text-xs text-amber-600 hover:text-amber-700 hover:underline flex items-center gap-1 font-bold"
          >
              ...
              <tbody className="divide-y divide-slate-100">
                {orders.slice(0, 5).map((o) => (
                  <tr key={o.id} className="hover:bg-slate-50/80 transition-colors">
                    ...
                    <td className="py-3.5 px-4 font-mono font-bold text-slate-900">
                      {(o.total || 0).toLocaleString()} <span className="text-amber-600 font-sans text-[11px] font-bold">ج.م</span>
                    </td>
                    <td className="py-3.5 px-4">
